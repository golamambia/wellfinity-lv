...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Edit Job Page</li>
    </ol>
  </section>
    ...
    <div class="row">
      ...
      <div class="col-xm-12 col-sm-12 col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="{{ url('/admin/jobpage/update/') }}"  method="post" enctype="multipart/form-data" class="formvalidation">
            ...
            <div class="box-body">
              ...
              <div class="form-group clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="btn_url" id="btn_url" placeholder="Enter ..." value="{{ $page[0]->btn_url }}">
                </div>
              </div>
              <div class="form-group clearfix">
                <label class="col-sm-2 control-label">Banner Button Text</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="btn_text" id="btn_text" placeholder="Enter ..." value="{{ $page[0]->btn_text }}">
                </div>
              </div>
              ...
              <div class="form-group clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="job_type" id="job_type" placeholder="Enter ..." value="{{ $page[0]->job_type }}">
                </div>
              </div>
              <div class="form-group clearfix">
                <label class="col-sm-2 control-label">Location</label>
                <div class="col-sm-10">
                  <textarea class="form-control " name="location" placeholder="Enter ...">{{ $page[0]->location }}</textarea>
                </div>
              </div>
