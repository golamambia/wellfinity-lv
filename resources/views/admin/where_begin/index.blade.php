...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Where to begin</li>
    </ol>
  </section>
          ...
          <div class="box-body table-responsive">
            ...
            <table id="example2" class="table table-bordered table-hover dataTable">
              ...
              @endif
                  ...
                  <td>
                    <a href="{{ url('/admin/where_begin/edit/'.$page->id) }}" title="Edit"><i class="fa fa-fw fa-edit"></i></a>
                    <a href="{{ url($page->slug) }}" title="View" target="_blank"><i class="fa fa-fw fa-eye"></i></a>
                    @if($page->id>0)
                    <a href="{{ url('/admin/where_begin/delete/'.$page->id) }}" onclick="return confirm('Are you sure?');" title="Delete"><i class="fa fa-fw fa-close"></i></a>
                    @endif
                  </td>
