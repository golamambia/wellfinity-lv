          ...
          <form role="form" action="{{ url('/admin/testimonial/update/') }}"  method="post" enctype="multipart/form-data" class="formvalidation">
            ...
            <div class="box-body">
              ...
              <div class="form-group clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="rank" id="rank" data-validation-engine="validate[required,custom[integer]]" placeholder="Enter ..." value="{{ $list->rank }}">
                </div>
              </div>
               ...
               <div class="form-group clearfix">
                ...
                <div class="col-sm-10">
                  <select name="rating" id="rating" class="form-control">
                    <option value="1" {!!$list->rating=='1'?'selected':''!!}>1</option>
                    <option value="2" {!!$list->rating=='2'?'selected':''!!}>2</option>
                     <option value="3" {!!$list->rating=='3'?'selected':''!!}>3</option>
                    <option value="4" {!!$list->rating=='4'?'selected':''!!}>4</option>
                     <option value="5" {!!$list->rating=='5'?'selected':''!!}>5</option>
