            ...
            <div class="box-body">
              ...
              <!-- <div class="form-group clearfix bannerimage">
                ...
                @foreach($page_extra as $val)
                  ...
                  @endif
                  @if($val->section_type=="1" || $val->section_type==4 || $val->section_type==13 || $val->section_type==14 || $val->section_type==15 || $val->section_type==16 || $val->section_type==17 || $val->section_type==18 || $val->section_type==19 || $val->section_type==20  || $val->section_type==21 || $val->section_type==22 || $val->section_type==23)
                    <div class="form-group clearfix">
                  ...
                  @endif 
                  @if($val->section_type==1 || $val->section_type==5 || $val->section_type==6 || $val->section_type==7 || $val->section_type==10 || $val->section_type==12 || $val->section_type==15 || $val->section_type==17 || $val->section_type==19 || $val->section_type==20 || $val->section_type==23)
                    <div class="form-group clearfix">
