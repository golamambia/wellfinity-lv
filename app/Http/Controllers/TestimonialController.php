...
class TestimonialController extends Controller
{
	...
	public function index()
	{
		...
		$column_array = array('id' => 'Id', 'name' => 'Name', 'designation' => 'Designation', 'rank' => 'Rank', 'status' => 'Status', 'created_at' => 'Created At');
	...
	public function insert(Request $request)
	{
		...
		if ($validator->fails())
		{
			return Redirect::to('admin/testimonial/add')->withErrors($validator)->withInput(); 
		}
		else
		{
			try {
	...
	public function update(Request $request)
	{
		...
		if ($validator->fails())
		{
			return Redirect::to('admin/testimonial/edit/'.$id)->withErrors($validator)->withInput(); 
		}
		else
		{
			try {
