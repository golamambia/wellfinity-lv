...
class Service_workController extends Controller
{
	...
	public function index()
	{
		...
		$lists = Service_work::whereRaw($where)
		...
		return view('admin.service_work.index', compact('lists','column_array','sorting_array','search'));
	}

	public function add()
	{
		return view('admin.service_work.add');
	}
	...
	public function insert(Request $request)
	{
		...
		if ($validator->fails())
		{
			return Redirect::to('admin/service_work/add')->withErrors($validator)->withInput(); 
		}
		else
		{
			try {
	...
	{
		$list = Service_work::where('id',$id)->first();
		return view('admin.service_work.edit', compact('list'));
	}
	...
	public function update(Request $request)
	{
		...
		if ($validator->fails())
		{
			return Redirect::to('admin/service_work/edit/'.$id)->withErrors($validator)->withInput(); 
		}
		else
		{
			try {

			$obj = Service_work::find($id); 
			$obj->rank = $request->rank;
			$obj->name = $name;
			// $obj->body = $request->body;
			// $obj->category_id = $request->category_id;
