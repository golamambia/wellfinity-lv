...
class ServiceOfferedController extends Controller
{
	...
	public function index()
	{
		...
		return view('admin.service_offered.index', compact('pages','column_array','sorting_array','search'));
	}
	...
	{
		$all_pages = Page::get();
		return view('admin.service_offered.add', compact('all_pages'));
	}
	...
	public function edit($id)
	{
		...
		return view('admin.service_offered.edit', compact('page','page_extra','all_pages'));
	}
