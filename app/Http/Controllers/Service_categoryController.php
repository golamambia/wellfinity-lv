...
class Service_categoryController extends Controller
{
	...
	public function index()
	{
		...
		$lists = Service_category::whereRaw($where)
		...
		return view('admin.service_category.index', compact('lists','column_array','sorting_array','search'));
	}

	public function add()
	{
		return view('admin.service_category.add');
	}
	...
	{
		$list = Service_category::where('id',$id)->first();
		return view('admin.service_category.edit', compact('list'));
	}
