...
class Team_categoryController extends Controller
{
	...
	public function index()
	{
		...
		$lists = Team_category::whereRaw($where)
		...
		return view('admin.team_category.index', compact('lists','column_array','sorting_array','search'));
	}

	public function add()
	{
		return view('admin.team_category.add');
	}
	...
	public function insert(Request $request)
	{
		...
		if ($validator->fails())
		{
			return Redirect::to('admin/team_category/add')->withErrors($validator)->withInput(); 
		}
		else
		{
			try {
	...
	{
		$list = Team_category::where('id',$id)->first();
		return view('admin.team_category.edit', compact('list'));
	}
	...
	public function update(Request $request)
	{
		...
		if ($validator->fails())
		{
			return Redirect::to('admin/team_category/edit/'.$id)->withErrors($validator)->withInput(); 
		}
		else
		{
			try {

			$obj = Team_category::find($id); 
			$obj->rank = $request->rank;
			$obj->name = $name;
			// $obj->body = $request->body;
			// $obj->category_id = $request->category_id;
