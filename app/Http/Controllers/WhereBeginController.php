...
class WhereBeginController extends Controller
{
	...
	public function index()
	{
		...
		return view('admin.where_begin.index', compact('pages','column_array','sorting_array','search'));
	}
	...
	public function insert(Request $request)
	{
		...
		$page_template = $request->page_template>0?$request->page_template:0;
				...
				return Redirect::to('admin/where_begin/edit/'.$page_id)->with('admin_msg', 'Page has been added successfully.');
	...
	public function edit($id)
	{
		...
		return view('admin.where_begin.edit', compact('page','page_extra','all_pages'));
	}
	...
	public function update(Request $request)
	{
		...
		if ($validator->fails())
		{
			return Redirect::to('admin/where_begin/edit/'.$id)->withErrors($validator) 
			->withInput(); 
		}
		else
		{
